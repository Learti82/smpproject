    ...
    <header id="header">
        <nav class="container">
            <a id="logo" href="index.html">
                <img src="images/barbershop-tools.jpg" alt="SMP Logo" title="SMP Logo">
            </a>
            <ul id="navbar">
        ...
        <section id="banner">
            <img src="images/shutterstock.jpg" alt="Banner 1" title="Banner 1">
            <h1> Sistemi për menaxhimin e klienteve </h1>
        </section>
    </header>
