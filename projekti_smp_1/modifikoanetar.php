<?php include 'inc/header.php';?>
    <main class="container page">
        <article id="maininfo">
            ...
            <p>
                Sistemi për menaxhimin e nje Salloni qe mundëson menaxhimin e punëve nga punëtorët e saj. Sistemi ofron
                menaxhimin e stafit: shtimin, modifikimin fshirjen, paraqitjen e terminit,
                menaxhimin e terminit: shtimin, modifikimin fshirjen, paraqitjen, etj.
            </p>
